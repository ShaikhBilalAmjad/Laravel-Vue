        ...
        <div class="col-md-12">
            <div class="card border-0">
                <div class="card-header bg-transparent">
                    <h5 class="float-start">Feedbacks</h5>
                                ...
                                <tr>
                                    ...
                                    <th class="px-6 py-3 bg-gray-50 text-left">
                                        <v-select multiple v-model="search_category" :options="categoryList"
                                                :reduce="category => category.id" label="name" class="form-control w-100 p-0 border-0"/>
                                    </th>
                                    <th class="px-6 py-3 bg-gray-50 text-left">
                    ...
                    <div >
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 bg-gray-50 text-left">
                                    <span class="text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Feedback by</span>
                                </th>
                            ...
                            <tr v-for="post in posts.data" :key="post.id">
                                ...
                                <td class="px-6 py-4 text-sm">
                                    <img :src="post.original_image" alt="image" height="30">
                                </td>
                                <td class="px-6 py-4 text-sm">
                                ...
                                <td class="px-6 py-4 text-sm">
                                    ...
                                    <router-link v-if="can('comment-create')"
                                                 :to="{ name: 'comments.create', params: { postid: post.id } }" class="ms-2 badge bg-success">comment
                                    </router-link>
