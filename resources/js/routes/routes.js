...
const CommentsIndex  = ()  => import('../views/admin/comments/Index.vue');
const CommentsCreate  = ()  => import('../views/admin/comments/Create.vue');
const CommentsEdit  = ()  => import('../views/admin/comments/Edit.vue');
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                meta: { breadCrumb: 'Add new feedback' }
            },
            {
                name: 'posts.edit',
                path: 'posts/edit/:id',
                component: PostsEdit,
                meta: { breadCrumb: 'Edit feedback' }
            },
            {
                name: 'comments.index',
                path: 'comments',
            ...
            },
            {
                ...
                meta: { breadCrumb: 'Add new comment' }
            },
            {
                name: 'comments.edit',
                path: 'comments/edit/:id',
                component: CommentsEdit,
                meta: { breadCrumb: 'Edit comments' }
            },
            {
